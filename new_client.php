        ...
        <div>
            <div class="signinForm">
                <form id="Sign in" method="post">
                    ...
                    <small>
                        Your password must be from 8 characters long, contain letters, numbers and special characters.
                    </small>
                    <br>
            ...
            <div class="signinForm">
                <form action="new_client.php" method="post">
                    <fieldset>
                        ...
                        <label for="bigLeters">Big letters without o and O</label><br>
                        <input type="checkbox" id="Small_letters" name="Sletters" value="true">
                        <label for="smallLeters"> Small letters without "l"</label>
